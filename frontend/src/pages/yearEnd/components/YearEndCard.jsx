...
export default function YearEndCard() {
  ...
  const years = useMemo(
    () => Array.from({ length: FUTURE_YEARS }, (_, i) => currentYear + i),
    [currentYear]
  );
    ...
    <>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Set the base leave quotas to be assigned to all employees along
              with carry-over and policies.
            </p>
            ...
            <div className="mb-6 p-5 bg-gray-50 rounded-3xl border border-gray-100">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <span className="text-xs text-gray-400 font-medium">
                  (Set <strong>0</strong> for Unlimited. This applies to all
                  leave types unless overridden.)
                </span>
              </div>
            </div>
      ...
      ${targetYearOpen ? "ring-2 ring-blue-100" : ""}`}
                ...
                {targetYearOpen && (
                  <>
                    ...
                    {/* dropdown */}
                    <div className="absolute left-0 top-full z-20 mt-2 w-full rounded-3xl bg-white shadow-xl border border-gray-100 overflow-hidden">
                      {years.map((y) => (
                        <button
                          key={y}
                          type="button"
      ...
      <div className="mt-6 flex items-center gap-3 text-amber-700 bg-amber-50 p-4 rounded-3xl border border-amber-100">
        ...
        <div className="text-xs font-bold leading-relaxed uppercase tracking-tight">
          ...
          employees in the target year. And immediately lock last year's data.
