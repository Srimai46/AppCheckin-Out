...
async function main() {
  console.log(
    "🌱 Start seeding (Target Year: 2026) with Dynamic Role & Department...",
  );
  ...
  const leaveTypesData = [
    {
      typeName: "Sick",
      label: { th: "ลาป่วย", en: "Sick", ja: "病気休暇" },
      isPaid: true,
      maxCarryOver: 0,
      color: "#EF4444", // 🔴 สีแดง
    },
    {
      typeName: "Personal",
      label: { th: "ลากิจ", en: "Personal", ja: "私事休暇" },
      isPaid: true,
      maxCarryOver: 0,
      color: "#F59E0B", // 🟠 สีส้ม
    },
    {
      typeName: "Annual",
      label: { th: "ลาพักร้อน", en: "Annual", ja: "年次休暇" },
      isPaid: true,
      maxCarryOver: 12.0,
      color: "#3B82F6", // 🔵 สีฟ้า
    },
    {
      typeName: "Emergency",
      label: { th: "ลาฉุกเฉิน", en: "Emergency", ja: "緊急休暇" },
      isPaid: true,
      maxCarryOver: 0,
      color: "#DC2626", // 🔴 สีแดงเข้ม
    },
    {
      typeName: "Special",
      label: { th: "ลาพิเศษ", en: "Special", ja: "特別休暇" },
      isPaid: true,
      maxCarryOver: 0,
  ...
  for (const emp of createdEmployees) {
    for (const lt of leaveTypes) {
      const baseDays =
        lt.typeName === "Sick" ? 30 : lt.typeName === "Special" ? 0 : 6;
  ...
  const timeRecords = [
    {
      ...
      checkInTime: new Date("2026-01-02T08:00:00Z"),
      checkOutTime: new Date("2026-01-02T17:00:00Z"),
      isLate: false,
    ...
    {
      employeeId: somchai.id,
      workDate: new Date("2026-01-03"),
      checkInTime: new Date("2026-01-03T08:45:00Z"),
      checkOutTime: new Date("2026-01-03T17:00:00Z"),
      isLate: true,
      note: "Traffic jam",
      checkInStatus: "LATE",
      checkOutStatus: "NORMAL",
    },
    {
      ...
      checkInTime: new Date("2026-01-04T07:55:00Z"),
      checkOutTime: new Date("2026-01-04T17:05:00Z"),
      isLate: false,
      checkInStatus: "ON_TIME",
      checkOutStatus: "NORMAL",
    },
    {
      ...
      checkInTime: new Date("2026-01-05T08:10:00Z"),
      checkOutTime: new Date("2026-01-05T17:00:00Z"),
      isLate: true,
      checkInStatus: "LATE",
      checkOutStatus: "NORMAL",
    },
    {
      ...
      checkInTime: new Date("2026-01-06T08:00:00Z"),
      checkOutTime: null,
      isLate: false,
  ...
  const req3 = await prisma.leaveRequest.create({
    data: {
      employeeId: vichai.id,
      leaveTypeId: getTypeId("Personal"),
      ...
      status: "Rejected",
      rejectionReason: "Too many workers off",
    },
  });
  ...
  console.log(
    "✅ SEEDING COMPLETED FOR 2026: Dynamic Roles & Departments applied!",
  );
}
